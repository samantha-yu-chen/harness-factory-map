...
export const TARGET_WORKFLOW: TargetWorkflowStage[] = [
  ...
  },
  {
    id: 'build-agent',
    number: 6,
    label: 'Build task-specific Agent',
    description: 'Assemble role, tools, guardrails, memory, and evaluation cases.',
    stationIds: ['agent-workshop', 'orchestrator-control-tower', 'sandbox', 'review-station'],
    specId: 'agent-package',
    color: '#31b86b',
  },
  {
    id: 'deliver-agent',
    number: 7,
    label: 'Deliver task-specific Agent',
    description: 'Hand off the reviewed package to its bounded runtime.',
    stationIds: ['delivery-dock'],
    specId: 'agent-delivery',
    color: '#3b82f6',
    branch: 'PACKAGE READY → runtime run · delivery ≠ task complete',
  },
  {
    id: 'learning',
    number: 8,
    label: 'Loop engineering',
    description: 'Review task outcome, evidence, and feedback for human-led improvement.',
