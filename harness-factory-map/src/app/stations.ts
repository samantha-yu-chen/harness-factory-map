...
export const STATIONS: StationDefinition[] = [
  ...
  { id: 'agent-workshop', label: 'Agent Workshop', specId: 'agent-package', position: [2, 0, 0], screenPosition: { left: '63%', top: '52%' }, color: '#22c55e', zone: 'execution' },
  ...
  { id: 'delivery-dock', label: 'Agent Delivery Dock', specId: 'agent-delivery', position: [5, 0, 3], screenPosition: { left: '80%', top: '79%' }, color: '#2563eb', zone: 'delivery' },
