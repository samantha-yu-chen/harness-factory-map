...
The Markdown files under `specs/` are the working material — editable, reviewable, argued over. The generated map is the deliverable: a validated, cross-checked view of twenty-six components across eight stages, each with a boundary, a contract, a named accountable human, and a cost.
...
| 3 | Reuse and governance | 4 | Registered teams, the reuse check, the LT approval flow |
| 4 | Learning loop | 3 | Metrics, improvement proposals, team retirement |

Waves 1 and 2 are the MVP. Wave 3 is what makes the platform governable at scale rather than by memory. Wave 4 is what stops it decaying.
